...
describe('featTokens 与 ml/textfeat.py 一致', () => {
  const cases: Array<[{ prev: string; text: string; next: string; pos: number }, string]> = [
    ...
    [
      { prev: '', text: '累到无力抵抗', next: '当我们的自控力像肌肉一样疲劳时就很难坚持。', pos: 0.3 },
      'L0 P0 Q1 NX1 PV0',
    ],
    [
      {
        prev: '',
        text: 'CHAPTER I',
        next: 'It was the best of times, it was the worst of times, and everybody knew it.',
        pos: 0.0,
      },
      'L1 P0 Q0 NX1 PV0',
    ],
    [
      { prev: 'short', text: '后记', next: '这本书到这里就结束了，感谢每一位读者的陪伴与支持。', pos: 0.99 },
      'L0 P0 Q3 NX1 PV0',
    ],
